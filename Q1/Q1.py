...
if __name__ == '__main__':
    ...
    print('************************************* Plot of K vs normalised mutual information (NMI) ************************')
    nmi_scores = []
    for k in range(2, 9):
        km = KMeans(k)
        km.fit(features)
